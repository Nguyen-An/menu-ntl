      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-gray-500 text-sm">
            Your order has been placed successfully, {userName}.
          </p>
          <Button
    ...
    <div className="min-h-screen bg-gray-50 pb-6">
      ...
      <div className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <h1 className="font-bold text-gray-900 text-base">Your Order</h1>
          <div className="w-6" />
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-4 flex flex-col gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-semibold text-gray-800">{totalItems} item{totalItems !== 1 ? 's' : ''}</h2>
